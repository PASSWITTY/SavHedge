...
const Options = () => {
  ...
  let fixedSectionClasses =
    'bg-gradient-to-r from-[#9b5d16] via-[#ebb679] to-[#7c4a12] border-b-2 border-[#f5f5f5]';
  if (currentDiv === 'investment') {
    fixedSectionClasses =
      'bg-gradient-to-r from-[#9b5d16] via-[#ebb679] to-[#7c4a12]';
    ...
    fixedSectionClasses =
      ' bg-gradient-to-r from-[#067187] via-[#FDE2ED] to-[#F6ACC5] ';
  ...
  return (
    <div className='opacity-90'>
      <div
        id='fixed-section'
        className={`flex flex-row h-11 items-center w-screen ${fixedSectionClasses}`}
      >
        <h2
      ...
      <div id='investment' style={{ display: currentDiv === 'investment' ? 'block' : 'none' }}>
        <div className='flex flex-row h-96'>
          <div
            id='help2'
            className='bg-[#ba701b] flex flex-col justify-center w-3/12 items-center hidden md:block'
          >
          ...
          <div
            id='help'
            className='w-4/12 bg-cover bg-center bg-no-repeat hidden md:block'
            style={{ backgroundImage: `url(${development})` }}
          ></div>
          <div
            id='help2'
            className='w-full md:hidden bg-cover bg-center bg-no-repeat'
            style={{ backgroundImage: `url(${development})` }}
          >
            <div className='h-full w-full flex flex-col justify-center items-center bg-black bg-opacity-90'>
              <p className='text-white font-bold text-xl tracking-widest leading-10 text-center py-6 px-5'>
                Check opportunities
              </p>
              <Typed
      ...
      <div id='incubation' style={{ display: currentDiv === 'incubation' ? 'block' : 'none' }}>
        <div className='flex flex-row h-96'>
          <div
            id='help2'
            className='bg-green-400 flex flex-col justify-center w-3/12 items-center hidden md:block'
          >
            <p className='p-4'>Check opportunities</p>
            <Typed
              className=' md:pl-4 pl-2'
      ...
      <div id='development' style={{ display: currentDiv === 'development' ? 'block' : 'none' }}>
        <div className='flex flex-row h-96'>
          <div
            id='help2'
            className='bg-[#67A3D9] flex flex-col justify-center w-3/12 items-center hidden md:block'
          >
            <p className='p-4'>Check opportunities</p>
            <Typed
              className=' md:pl-4 pl-2'
